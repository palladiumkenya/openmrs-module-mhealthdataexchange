...
public class NEXT_OF_KIN {
	...
	public String toString() {
		return "NEXT_OF_KIN{" + "nok_name=" + nok_name + ", relationship='" + relationship + '\'' + ", address='" + address
		        + '\'' + ", phone_number='" + phone_number + '\'' + ", sex='" + sex + '\'' + ", date_of_birth='"
		        + date_of_birth + '\'' + ", contact_role='" + contact_role + '\'' + '}';
	}
}
