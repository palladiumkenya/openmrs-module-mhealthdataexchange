...
public class PATIENT_ADDRESS {
	...
	public static PATIENT_ADDRESS fill(JsonObject jsonobj) {
		...
		if (jsonobj.containsKey("PHYSICAL_ADDRESS")) {
			...
			try {
				PHYSICAL_ADDRESS physical_address = objectMapper.readValue(jsonobj.getJsonObject("PHYSICAL_ADDRESS")
				        .toString(), PHYSICAL_ADDRESS.class);
	...
	public String toString() {
		return "PATIENT_ADDRESS{" + "physical_address=" + physical_address + ", postal_address='" + postal_address + '\''
		        + '}';
	}
}
