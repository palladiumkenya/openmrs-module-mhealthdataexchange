...
/**
 * This is a unit test, which verifies logic in MhealthdataexchangeService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class MhealthdataexchangeServiceTest {
	
	@InjectMocks
	MhealthdataexchangeServiceImpl basicModuleService;
